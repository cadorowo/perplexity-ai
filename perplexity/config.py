...
MODEL_MAPPINGS: Dict[str, Dict[str, str]] = {
    ...
    "pro": {
        ...
        "claude sonnet 5": "claude5sonnet",
        "claude-sonnet-5": "claude5sonnet",
        "claude opus 5": "claude5opus",
    ...
    "reasoning": {
        ...
        "claude sonnet 5": "claude5sonnetthinking",
        "claude-sonnet-5": "claude5sonnetthinking",
        "claude sonnet 5 thinking": "claude5sonnetthinking",
        "claude-sonnet-5-thinking": "claude5sonnetthinking",
        "gpt5": "gpt5",
        "gpt5_thinking": "gpt5thinking",
        "gpt-5.2-thinking": "gpt52_thinking",
        "gpt-5.6 terra": "gpt56terrathinking",
        "gpt-5.6-terra": "gpt56terrathinking",
